...
<body>
	...
	<main>
		...
		<div id="contact">
			...
			<?php
				echo '<h1 style="text-align:center; padding: 10px; background-color: #d7d6d6;border-radius: 5px;font-size: 1.3em">Thank you for sending e-mail. Please check your e-mail!</h1>';
				...
				<body>
					<h1 style="text-align:center; padding: 10px; background-color: #d7d6d6;border-radius: 5px;font-size: 1.3em">Hello ' . $_POST['firstname'] . '.</h1>
